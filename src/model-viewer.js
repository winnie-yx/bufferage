...
export function initModelViewer({ canvas, onFocusLocked }) {
    ...
    const pedestalGlow = new THREE.Mesh(new THREE.CircleGeometry(2.8, 64), new THREE.MeshBasicMaterial({
        color: "#d8dff5",
        transparent: true,
        opacity: 0.08,
    ...
    const shadowPlane = new THREE.Mesh(new THREE.CircleGeometry(2.2, 64), new THREE.MeshBasicMaterial({
        color: "#000000",
        transparent: true,
        opacity: 0.18,
        depthWrite: false,
    ...
    const updateRayPointer = (clientX, clientY) => {
